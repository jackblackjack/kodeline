...
<dl>
  <dt><?php echo $form['options']['is_decimal']->renderLabel() ?>:</dt>
  <dd>
    <?php echo $form['options']['is_decimal']->render() ?>
    <span class="help"><?php echo $form['options']['is_decimal']->renderHelp() ?></span>

    <?php if ($form['options']['is_decimal']->hasError()): ?>
    <span><?php echo $form['options']['is_decimal']->renderError() ?></span>
    <?php endif ?>
  </dd>
</dl> 
