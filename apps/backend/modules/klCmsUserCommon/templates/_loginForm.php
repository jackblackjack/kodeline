  ...
  <form class="mws-form" action="<?php echo url_for('@user_login') ?>" method="post">
    ...
    <div class="mws-form-row">
      <div class="mws-form-item">
        <?php echo $form['username']->render(array('class' => 'mws-login-username required', 'placeholder' => 'username')) ?>
    ...
    <div class="mws-form-row">
      <div class="mws-form-item">
        <?php echo $form['password']->render(array('class' => 'mws-login-password required', 'placeholder' => 'password')) ?>
      </div>
    </div>
