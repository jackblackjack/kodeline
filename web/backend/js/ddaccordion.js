...
var ddaccordion={
	...
	jQuery(document).ready(function($){
		...
		if ('undefined' !== typeof(expandedindices) && 1 == expandedindices.length && expandedindices[0]=="-1") //check for expandedindices value of [-1], indicating persistence is on and no content expanded
			expandedindices=[]
