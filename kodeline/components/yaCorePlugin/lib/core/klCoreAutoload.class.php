<?php
//echo realpath(dirname(__FILE__) . '/../../../..') . '/vendor/symfony/lib/autoload/sfCoreAutoload.class.php'; die;
require_once(realpath(dirname(__FILE__) . '/../../../..') . '/vendor/symfony/lib/autoload/sfCoreAutoload.class.php');
  //sfCoreAutoload::register();

class klCoreAutoload extends sfCoreAutoload
{
  /**
   */
  protected $klCoreLibDir = null;
  ...
  {
    $this->klCoreLibDir = realpath(dirname(__FILE__) . '/..');
