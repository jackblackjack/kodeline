 ...
 * @version    SVN: $Id: sfSslRequirementActionMixin.class.php 2404 2010-10-11 21:09:55Z pinhead $
 */
class sfSslRequirementActionMixin
{
  ...
  static public function register(sfEventDispatcher $dispatcher)
  {
    ...
    $dispatcher->connect('action.method_not_found', array($mixin, 'listenToMethodNotFound'));
