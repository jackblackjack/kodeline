...
<div class="clearfix">
  <div>
    <?php echo $form->renderFormTag(url_for2('homepage', array('forum_id' => 1)), array('method' => 'post', 'id' => 'attachments-form-' . $formKey)) ?>
        ...
        <div id="attachments-key-<?php echo $formKey ?>">
          <div class="box__r">
            <div class="attachments-menu">
              <a class="attachments-menu-header" href="#">Прикрепить</a>
                      ...
                      <div class="clearfix">
                        <span class="gray-btn gray-btn__small btn-file ib box__w170  box__mr13 box__l">
                          <span class="gray-btn gray-btn__small btn-file ib box__w170  box__mr13 box__l" id="add-file-upload-block">
                            ...
                            <span class="btn-file-text" id="add-file-upload-button">Выберите изображение</span>
                          </span>
                        </span>
...
jQuery(document).ready(function() {
  jQuery("#attachments-accordion-<?php echo $formKey ?>").accordion();
