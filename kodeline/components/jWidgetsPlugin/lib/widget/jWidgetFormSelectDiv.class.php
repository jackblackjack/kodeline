<?php
/**
 * jWidgetFormSelectDiv represents a select HTML tag.
 *
 * @package    symfony
 * @subpackage widget
...
*/
class jWidgetFormSelectDiv extends sfWidgetFormChoiceBase
{
  /**
   * Constructor.
   *
  ...
  protected function getOptionsForSelect($value, $choices)
  {
    ...
    foreach ($choices as $key => $option)
    {
      ...
      else
      {
        ...
        $options[] = $this->renderContentTag('span', self::escapeOnce($option), $attributes);
      }
    }
