<?php
abstract class BaseBackendKlCmsPermissionActions extends yaBaseActions
{
  /**
   * Default action.
  ...
  public function executeIndex(sfWebRequest $request)
  {
    ...
    $query = Doctrine::getTable('klPermission')->createQuery('klu');

    // Define configuration for pager.
    $arPagerConfig = sfConfig::get('app_klCmsUsersPlugin_klCmsPermission_per_page', array('per_page' => 10));

    // Define pager.
    $this->items_pager = new klDoctrinePager('klPermission', $arPagerConfig['per_page']);
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->form = new klPermissionForm();
