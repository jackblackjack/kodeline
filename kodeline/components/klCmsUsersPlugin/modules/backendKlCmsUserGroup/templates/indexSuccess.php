...
<a href="<?php echo url_for('@parameterable_component?model=klUserGroup') ?>">Поля пользовательских групп</a>
<a href="<?php echo url_for('@backend_user_group_new') ?>">Добавить пользовательскую группу</a>
