 ...
 * @version     $Id$
 */
class BaseBackendFxShopListActions extends BaseBackendElementActions
{
  /**
  ...
  public function executeCategoryNew(sfWebRequest $request)
  {
    ...
    $this->form = new FxShopListNewCategoryForm();
  ...
  public function executeCategoryEdit(sfWebRequest $request)
  {
    ...
    // Initiate form object.
    $this->form = new FxShopListEditCategoryForm($this->object);
